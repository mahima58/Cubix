...
export default function () {
    ...
    let params = {
        headers: {
            ...
            'Authorization': `Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzI3ODQ0MjYxLCJqdGkiOiI1YzY5MzY2YjFiZmU0MTJhODE2ZTBlMjYxNGM2NjY1YiIsInVzZXJfaWQiOjIsImRvbWFpbl9uYW1lIjoidGVzdGFwaS5zb29yaXNvbHV0aW9ucy5jb20ubnAiLCJ1c2VyX25hbWUiOiJtYWhpbWEifQ.vWKBeoCrOJ0ClPlbGkaAMsFigzRZmiPV41G2LPCASpA`, // Replace with your actual Bearer token
        },
    };

    // Make the POST request
    let res = http.post('https://testapi.soorisolutions.com.np/api/v1/warehouse-location-app/location', payload, params);

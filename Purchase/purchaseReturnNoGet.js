...
export default function () {
    ...
    let res = http.get('https://testapi.soorisolutions.com.np/api/v1/purchase-app/purchase-master-purchase-number?search=&offset=0&limit=10&party=1&department=1', params);
